...
//数据库名称
define('Mc_Sqlname','no2');

//数据库表前缀
define('Mc_SqlPrefix','mc_');

//数据库用户名
define('Mc_Sqluid','no2');

//数据库密码
define('Mc_Sqlpwd','cbR6ZWT4ThABLNcE');
...
//encryption_key密钥
define('Mc_Encryption_Key','KyEFSPqCi94gfXc');
...
//小说TXTMD5秘钥
define('Mc_Book_Key','NXeHcDKIVb1skdBnOSov');