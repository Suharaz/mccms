            ...
            <div class="layui-form toolbar">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="Admin.del('<?=links('ads','del')?>','admin')"><i class="layui-icon"></i>batch deletion</button>
            ...
            <table class="layui-table" lay-even lay-skin="row" lay-data="{url:'<?=links('ads','ajax')?>',limit:20,limits:[20,30,50,100,500],page:{layout:['count','prev','page','next','refresh','skip','limit']},id:'admin'}" lay-filter="admin">
              <thead>
                ...
                <?php if(defined('MOBILE')){ ?>
                    ...
                    <th lay-data="{field:'label',align:'center'}">Label</th>
                    <th lay-data="{align:'center',templet:'#cmd2Tpl'}">Settings</th>
                <?php }else{ ?>
                    ...
                    <th lay-data="{align:'center',width:150,templet:'#cmdTpl'}">Settings</th>
                <?php } ?>
                </tr>
              </thead>
            </table>
