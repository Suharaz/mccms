        ...
        <div class="layui-card-body">
            <div class="layui-tab layui-tab-brief">
                <ul class="layui-tab-title">
                    <li<?php if($yid==0) echo ' class="layui-this"';?>><a href="<?=links('comic','chapter')?>?id=<?=$mid?>">reviewed chapter</a></li>
                    <li<?php if($yid==1) echo ' class="layui-this"';?>><a href="<?=links('comic','chapter',1)?>?id=<?=$mid?>">pending chapter</a></li>
                    <li<?php if($yid==2) echo ' class="layui-this"';?>><a href="<?=links('comic','chapter',2)?>?id=<?=$mid?>">failed chapter</a></li>
                </ul>
                        ...
                        <div class="layui-form toolbar">
                            <div class="layui-form-item" style="margin-top: 10px;">
                                <div class="layui-inline">
                                    ...
                                    <button class="layui-btn layui-btn-sm layui-btn-normal" onclick="get_px('comic')">to sort</button>
                                    <button class="layui-btn layui-btn-sm" onclick="get_vip('comic',1)">set VIP</button>
                                    <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="get_vip('comic',2)">Cancel VIP</button>
                                    <button class="layui-btn layui-btn-sm layui-btn-normal" onclick="get_cion('comic')">set charges</button>
                                    <?php if($mid > 0): ?>
