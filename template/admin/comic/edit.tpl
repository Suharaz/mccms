    ...
    <form class="layui-form layui-form-pane" action="<?=links('comic','save')?>">
        <div class="layui-form-item">
            <div class="layui-col-xs12 layui-col-md3">
                <label class="layui-form-label">Comic Genre</label>
            ...
            <div class="layui-col-xs12 layui-col-md3">
                <label class="layui-form-label">manga status</label>
                <div class="layui-input-block">
                    <select name="serialize">
                        <option value="完结">End</option>
                        <option value="连载"<?php if(strpos($serialize,'连载') !== false) echo 'selected';?>>OnGoing</option>
                    </select>
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md2">
                <label class="layui-form-label">Lock</label>
                <div class="layui-input-block">
                    <select name="sid">
                        <option value="0">No</option>
                        <option value="1"<?php if($sid == 1) echo 'selected';?>>Yes</option>
                    </select>
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md2">
                <label class="layui-form-label">recommended</label>
                <div class="layui-input-block">
                    <select name="tid">
                        <option value="0">No</option>
                        <option value="1"<?php if($tid == 1) echo 'selected';?>>Yes</option>
                    </select>
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md2 label80">
                <label class="layui-form-label">review</label>
                <div class="layui-input-block">
            ...
            <div class="layui-col-xs12 layui-col-md4">
                <label class="layui-form-label">nhóm dịch</label>
                <div class="layui-input-block">
                    <input type="text" name="author" class="layui-input" value="<?=$author?>" placeholder="">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md4">
                <label class="layui-form-label">English alias</label>
                <div class="layui-input-block">
                    <input type="text" name="yname" class="layui-input" value="<?=$yname?>" placeholder="Please enter the comic English alias">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md4">
                <div class="layui-input-inline">
                    <input type="checkbox" name="addtime" title="update time" checked>
                </div>
                <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <div class="layui-col-xs12 layui-col-md4">
                <label class="layui-form-label">manga title</label>
                <div class="layui-input-block">
                    <input type="text" name="name" required lay-verify="required" class="layui-input" value="<?=$name?>" placeholder="请输入漫画标题">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md3">
                <label class="layui-form-label">Total Score</label>
                <div class="layui-input-block">
                    <input type="number" name="score" class="layui-input" value="<?=$score?>" placeholder="Comic Rating Total Score">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md5">
                <label class="layui-form-label">Sumary</label>
                <div class="layui-input-block">
                    <input type="text" name="text" class="layui-input" value="<?=$text?>" placeholder="Introduce the manga in one sentence, within 10 words">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-col-xs12 layui-col-md6">
                <label class="layui-form-label">vertical cover</label>
                <div class="layui-input-block">
            ...
            <div class="layui-col-xs12 layui-col-md6">
                <label class="layui-form-label">Horizontal cover</label>
                <div class="layui-input-block">
        ...
        <div class="layui-form-item">
            <div class="layui-col-xs12 layui-col-md6">
                <label class="layui-form-label">Author_art</label>
                <div class="layui-input-block">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">Thông báo</label>
            <div class="layui-input-block">
                <textarea id="editor2" name="notice" placeholder="作者漫画公告" class="layui-textarea"><?=$notice?></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">Introduction to comics</label>
            <div class="layui-input-block">
        ...
        <div class="layui-form-item" style="text-align: center;">
            ...
            <button class="layui-btn" lay-filter="*" lay-submit>keep</button>
