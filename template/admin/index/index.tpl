...
<div class="container">
    ...
    <div class="left_open">
        <a><i title="expand left column" class="layui-icon">&#xe668;</i></a>
    </div>
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item"><a onclick="Admin.delcache('<?=links('index','caches')?>');" title="F5"><i class="layui-icon" style="font-size:16px;">&#xe669;</i></a></li>
        <li class="layui-nav-item">
            <a href="javascript:;"><?=$this->cookie->get('admin_nichen')?></a>
            <dl class="layui-nav-child">
                <dd><a onclick="get_pass();">change Password</a></dd>
                <dd><a href="<?=links('logout')?>">quit</a></dd>
            </dl>
        </li>
        <li class="layui-nav-item to-index"><a href="<?=Web_Path?>" target="_blank">Go to Site</a></li>
    </ul>
</div>
<!-- 顶部结束 -->
<!-- 中部开始 -->
...
<div class="page-content">
    <div class="layui-tab tab" lay-filter="iframe" lay-allowclose="false">
        ...
        <div class="layui-unselect layui-form-select layui-form-selected" id="tab_right">
            <dl>
                <dd data-type="this">close all</dd>
...
function get_pass(){
    layer.prompt({title: 'Please enter a new password',area: ['200px', '150px']},function(value, index, elem){
